...
export const CarrierCard = ({ carrier, onEdit, onDelete, onCopy, showHeader = false }: CarrierCardProps) => {
  ...
  return (
    <>
      {showHeader && (
        <div className="border-b bg-gray-100 p-4 font-medium text-sm text-gray-700">
          <div className="grid grid-cols-1 md:grid-cols-8 gap-4 items-center">
            ...
            <div>Price</div>
            <div>Term</div>
            <div className="md:col-span-2">Options & Notes</div>
            <div>Actions</div>
          </div>
        </div>
      )}
